      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-10 px-6 text-center md:flex-row md:text-left">
        <div>
          ...
          <p className="mt-4 text-lg text-white/80">
            Exclusive access to our private sale. Up to 40% off selected items.
          </p>
        </div>
        <button className="rounded-2xl bg-white px-8 py-4 font-semibold text-primary transition hover:scale-105">
          Shop the Sale
        </button>
      </div>
    </section>
