  ...
  return (
    <div className="p-6 min-h-screen bg-[#f8f8ff]">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-lg font-semibold text-gray-800">Newsletter</h1>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 border border-[#6C63FF] text-[#6C63FF] text-sm font-medium rounded-xl hover:bg-[#f5f5ff] transition"
        >
      ...
      <div className="flex flex-col gap-3 md:hidden">
        {filtered.length === 0 ? (
          ...
          filtered.map((subscriber) => (
            <div
              key={subscriber.id}
              className="bg-white border border-[#e0e0ff] rounded-2xl p-4 flex items-center justify-between"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1 mt-0.5">
                    <MdOutlineEmail size={11} className="text-gray-400" />
              ...
              <button
                onClick={() => setDeleteTarget(subscriber)}
                className="w-8 h-8 flex items-center justify-center rounded-lg border border-[#e0e0ff] text-gray-400 hover:border-red-400 hover:text-red-400 hover:bg-red-50 transition shrink-0"
              >
                <MdOutlineDelete size={16} />
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-2xl shadow-xl p-6 w-80">
            ...
            <p className="text-xs text-gray-500 mb-1">
              This subscriber will be removed:
            </p>
